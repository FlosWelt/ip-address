  ...
  return (
    <div className="bg-gray-900 h-screen">
      ...
      <div>
        ...
        <p className="text-center text-white">The Ip Lookup function is powerd by <a className="underline" href="https://www.ip-api.com" target="_blank" rel="noreferrer" >ip-api.com</a></p>
